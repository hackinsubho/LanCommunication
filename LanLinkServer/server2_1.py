...
class testserver(wx.Frame):
    def __init__(self):
        wx.Frame.__init__(self, None, wx.NewId(),"Server",size=(450,550))
        ...
        self.image = wx.Image('/home/cyrus/Desktop/LanLink-master/LanLinkServer/logo_final.png', wx.BITMAP_TYPE_ANY).ConvertToBitmap()
